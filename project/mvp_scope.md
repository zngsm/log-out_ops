...
- 인트라넷 로그인 폼, 출근 버튼, 업무 헤더 및 보고서 버튼의 개발용/기획용 메타 텍스트 (`🔒 READ-ONLY`, "시스템 자동 인증이 완료되었습니다...", "Clock-in :: 2분할 업무 화면 진입", "(다음 업무로 이동)", 개발자 지침풍 ECHO 대사, "HERMES 2-SPLIT DUAL PANEL", "라포 Phase" 등)
