...
6. Human answers: `project/human-input/LOG_OUT_PM_QA.md`
7. PM-derived specs and task docs
...
| --- | --- | --- | --- | --- |
| feat-012 | feat | Add main menu and directed opening sequence | feat-008, feat-009, feat-010 | Recreate the original menu-to-60-second-opening-to-terminal transition |
...
| feat-019 | feat | Integrate 3D control room with scene and resource state | feat-009, feat-012, feat-015 | Make lighting/camera/monitor states react to the game |
