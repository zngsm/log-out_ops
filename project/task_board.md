...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | feat-001 | feat | Bootstrap Vite + React game project | done | dev-agent | no | none | feat-002, feat-003, feat-004 | project/tasks/feat-001.md |
...
| 6 | feat-005 | feat | Implement evidence attachment and act progression | blocked | dev-agent | no | feat-002, feat-003, feat-004, Q4 | feat-007, feat-008 | project/tasks/feat-005.md |
| 7 | feat-006 | feat | Implement Log Fixer recovery interaction | todo | dev-agent | yes | feat-002, feat-004 | feat-007 | project/tasks/feat-006.md |
| 8 | feat-007 | feat | Implement ECHO response rules for category A | blocked | dev-agent | no | feat-003, feat-005, feat-006, Q4, Q5 | qa-001 | project/tasks/feat-007.md |
| 9 | feat-008 | feat | Add opening, ending, visual, and audio feedback | blocked | dev-agent | yes | feat-002, feat-003, Q2, Q3, Q7 | qa-001 | project/tasks/feat-008.md |
| 10 | qa-001 | chore | Run MVP scenario QA and create bug tickets | blocked | qa-agent | no | feat-003, feat-007, feat-008 | bug tasks | project/tasks/qa-001.md |

## Parallel Work Notes

- `feat-002`, `feat-003`, `feat-004` can start after `feat-001` because they touch different layers: UI shell, game state, and content data.
...
- `feat-005`, `feat-007`, and `feat-008` require human answers before final implementation.
