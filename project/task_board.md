...
| 48 | feat-033 | feat | Build diegetic workstation layout, [확인 완료] button task flow, colleague messenger popup (top-right)/app UI with notification bubble (bottom-right), and candidate resume narrative evaluation | done | dev-agent | no | feat-032 | feat-034 | project/tasks/feat-033.md |
